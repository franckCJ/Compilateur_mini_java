...
let rec _menhir_goto_attribute_or_method : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.minijava) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | UIDENT _ ->
        _menhir_reduce11 _menhir_env (Obj.magic _menhir_stack) MenhirState21
    | CLOSEBRACKET ->
    ...
    | UIDENT _v ->
        ...
        | LIDENT _v ->
            ...
            | SEMICOLON ->
                ...
                let _ = _menhir_discard _menhir_env in
                let _menhir_stack = Obj.magic _menhir_stack in
                let (((_menhir_stack, _menhir_s, _), _), name) = _menhir_stack in
